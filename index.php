...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage"><span class="glyphicon glyphicon-home">OnlineExamination</span></a>
    </div>
...
<div  >
<img  width="100%" height="600"  src="http://www.whistlingconsultinggroup.com/wp-content/uploads/2014/01/Online-exam.png">
...
<div class="container-fluid bg-grey">
  <div class="row">
    <div class="col-sm-4">
     <img style="border-radius: 50%; height:400px;width:400px;" src="https://i0.wp.com/cqunilife.com/wp-content/uploads/2019/01/shutterstock_1013125333-1.jpg?fit=600%2C400&ssl=1">
    </div>
    <div class="col-sm-8">
      <h2>Our Values</h2><br>
...
<div id="feedback" class="container-fluid " style="background-color:grey;font-color:white;">
  <h2 class="text-center" style="color:white;">FeedBack</h2>
  <div class="row">
    <div class="col-sm-5">
      <h2 style="color:white;">You are free to provide us your suggestions and feedback.</h2>
